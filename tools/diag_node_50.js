// Higher-concurrency test to see if FOR UPDATE fails at higher load
const fs = require('fs');
...
async function main() {
  ...
  console.log(`50 concurrent done in ${Date.now() - t0}ms`);
  ...
  console.log(`empty=${empty} nonempty=${nonempty} (expected empty=45, nonempty=5)`);
